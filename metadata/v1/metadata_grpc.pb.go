...
func (c *metadataServiceClient) GetMetadata(ctx context.Context, in *GetMetadataRequest, opts ...grpc.CallOption) (*GetMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kapetn.service.metadata.v1.MetadataService/GetMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetadataService_GetMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kapetn.service.metadata.v1.MetadataService/GetMetadata",
	}
...
var MetadataService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kapetn.service.metadata.v1.MetadataService",
	...
	Metadata: "kapetn/service/metadata/v1/metadata.proto",
}
